...
const botname = process.env.BOTNAME || 'AMI AI';
const antibot = process.env.ANTIBOT || 'FALSE';
   ...
   const quoted = (fatkuns.mtype == 'buttonsMessage') ? fatkuns[Object.keys(fatkuns)[1]] : (fatkuns.mtype == 'templateMessage') ? fatkuns.hydratedTemplate[Object.keys(fatkuns.hydratedTemplate)[1]] : (fatkuns.mtype == 'product') ? fatkuns[Object.keys(fatkuns)[0]] : m.quoted ? m.quoted : m;
    ...
    const author = process.env.STICKER_AUTHOR ||'𝘼𝙈𝙄_𝘼𝙡'
    const packname = process.env.STICKER_PACKNAME ||'AMI;
const dev = process.env.DEV || '254799384249'
const menu = process.env.MENU_TYPE || 'VIDEO';
 const DevDreaded = dev.split(",");
   ...
   const bad = process.env.BAD_WORD || 'fuck';
    ...
    const thum = fs.readFileSync ('./𝘼𝙈𝙄_𝘼𝙡.jpg');	  
    const Owner = DevDreaded.map((v) => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net").includes(m.sender);
    const viewOnceMessage = args.join(" ");
    const fcontact = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `𝘼𝙈𝙄 𝐁𝐎𝐓`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;AmiBot,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/00c44dbca471eff754425.png' }}}}
       // Group
...
let { key } = await client.sendMessage(from, {text: '𝐈 𝐚𝐦 𝘼𝙈𝙄_𝐚𝐢'})
...
let { key } = await client.sendMessage(from, {text: '𖤍𝐏𝐨𝐧𝐠'})
...
"『 𖤍 𝙻𝚘𝚊𝚍𝚒𝚗𝚐... 』\n*[■■■■■■■□□□] 𝟾𝟶٪*",
"『 𖤍 𝙻𝚘𝚊𝚍𝚒𝚗𝚐... 』\n*[■■■■■■■■■■] 𝟷𝟶𝟶٪*",
"𖤍𝐋𝐨𝐚𝐝𝐢𝐧𝐠 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐛𝐲 𖤍 𝘼𝙈𝙄 𖤍! 😬"
]
let { key } = await client.sendMessage(from, {text: '𝐋𝐨𝐚𝐝𝐢𝐧𝐠 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐛𝐲 𖤍 𝘼𝙈𝙄 𖤍! )
...
if (antilink === 'TRUE' && antilinkall === 'TRUE' && body.includes('http') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, {text:`Auf wiedersehen:\n\n@${ki.split("@")[0]}, sending links is prohibited in this group!`, contextInfo:{mentionedJid:[ki]}}, {quoted:m}); 
    ...
    if (cmd && !m.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ 𖤍𝘼𝙈𝙄_𝘼𝙡𖤍 ]")), color(argsLog, "turquoise"), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
...
if (menu === 'VIDEO') {
                   ...
                   client.sendMessage(m.chat, {
                        video: fs.readFileSync('./Ami-ai menu.mp4'),
                        caption: cap,
                        gifPlayback: true
                    }, {
                        quoted: fcontact
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnail: fs.readFileSync('./𝘼𝙈𝙄_𝐀𝐈.jpg'),
...
break;
        ...
        client.sendMessage(from, { react: { text: "𖤍", key: m.key } })
...
case 'play2': {
  ...
  try {
    reply('𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐢𝐧𝐠 𝐲𝐨𝐮𝐫 𝐚𝐮𝐝𝐢𝐨 𖤍 𖤍 𖤍')
...
function _0x2de4() {
    const _0xca7309 = [
        ...
        'catch',
        'e\x20text.\x20Th',
        '\x20of\x20its developer 〄༒𝐇𝐀𝐌𝐌𝐘➳ᴹᴿ᭄',
        'is\x20AI\x20work',
        '1832596QZCVhJ',
        '\x20and\x20Googl',
        'AgaVJ',
...
break;
 ...
 m.reply('𝐁𝐨𝐭 𝐎𝐰𝐧𝐞𝐫 𝐂𝐫𝐨𝐰𝐧𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𖤍); 
          }
          break;
...
await m.reply('𝐑𝐞𝐦𝐨𝐯𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐛𝐲 𖤍𝘼𝙈𝙄_𝘼𝙡𖤍'); 
} catch (errr) { 
...
`👋🏻 Hi *${pushname}*,You can deploy 𝘼𝙈𝙄 𝐁𝐎𝐓 using the GitHub link below🗿\n\nFork and give us a star✨.\n\n https://github.com/Hamingtonmusyoki/Ami-ai\n\nEnjoy and have fun with the bot🗿...\n\nUse the link below to pair 𝘼𝙈𝙄_𝐀𝐈 without scanning any qr code\n\n [https://replit.com/@Hechem254/Pairing-Ami]\n\nType ${prefix}Tutorial and follow the steps if you dont know how to deploy the bot\n\n           Made by 〄༒𝐇𝐀𝐌𝐌𝐘➳ᴹᴿ᭄` });
 ...
 m.reply('Dissapearing messages successfully turned off!'); 
    ...
    reply('𝐆𝐫𝐨𝐮𝐩 𝐢𝐜𝐨𝐧 𝐮𝐩𝐝𝐚𝐭𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲'𖤍); 
    } 
    break;
 ...
 m.reply('Group name successfully updated! 𖤍); 
             } 
             break; 
 ...
 m.reply('Group description successfully updated! 𖤍👍'); 
             } 
 break; 
 case "hidetag": { 
             if (!m.isGroup) throw group; 
 ...
 if (!m.isGroup) throw group; 
  if (!Owner) throw `Owner Only` 
 client.sendMessage(m.chat, { text : q ? q : '☞︎︎︎ 𝐈 𝐃𝐈𝐃 𝐍𝐎𝐓 𝐓𝐀𝐆 𝐘𝐎𝐔 ☜︎' , mentions: participants.map(a => a.id)}, { quoted: fcontact }); 
 } 
 break;
 case "tagall": { 
                 if (!m.isGroup) throw group; 
...
break
  case 'play':
    case 'play2': {
        if (!text) {
            reply('𝐏𝐫𝐨𝐯𝐢𝐝𝐞 𝐚 𝐬𝐞𝐚𝐫𝐜𝐡 𝐭𝐞𝐫𝐦!\n𝐄.𝐠: 𝙿𝚕𝚊𝚢 perfect by nyashinski')
            return;
        }
        try {
            const {
...
m.reply (`⭓𝐏𝐨𝐧𝐠\n *${dreadedspeed.toFixed(4)}* 𝐌𝐬`);
 ...
 case "runtime": { 
                 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/a91218a98b91ec37fac81.mp4' }, caption: `𝘼𝙈𝙄_𝘼𝙡 𝙷𝚊𝚜 𝙱𝚎𝚎𝚗 𝙰𝚌𝚝𝚒𝚟𝚎 𝙵𝚘𝚛 ${runtime(process.uptime())}`,gifPlayback: true }, { quoted: m }); 
 } 
 break;

case "alive": { 
  
 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/5e29ca126d7a46aa3aef4.mp4' }, caption: `𝐇𝐞𝐥𝐥𝐨 *${m.pushName}*, 𝘼𝙈𝙄_𝘼𝙡 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐚𝐥𝐢𝐯𝐞 𝐬𝐢𝐧𝐜𝐞 *${runtime(process.uptime())}*,\n\n➥𝐓𝐲𝐩𝐞 ${prefix}𝐦𝐞𝐧𝐮 𝐭𝐨 𝐚𝐜𝐜𝐞𝐬𝐬 𝐦𝐲 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐥𝐢𝐬𝐭.\n➥𝐓𝐲𝐩𝐞 ${prefix}𝐫𝐞𝐩𝐨 𝐭𝐨 𝐠𝐞𝐭 𝐦𝐲 𝐬𝐨𝐮𝐫𝐜𝐞 𝐜𝐨𝐝𝐞.\n➥𝐓𝐲𝐩𝐞 ${prefix}𝐨𝐰𝐧𝐞𝐫 𝐭𝐨 𝐜𝐨𝐧𝐭𝐚𝐜𝐭 𝐦𝐲 𝐜𝐫𝐞𝐚𝐭𝐨𝐫.\n\n✘𝐄𝐧𝐣𝐨𝐲 𝐚𝐧𝐝 𝐇𝐚𝐯𝐞 𝐟𝐮𝐧 𝐰𝐢𝐭𝐡 𝐭𝐡𝐞 𝐛𝐨𝐭.\n✘𝐌𝐚𝐝𝐞 by 〄༒𝐇𝐀𝐌𝐌𝐘➳ᴹᴿ᭄ꪶ ࣩࣩࣩࣩ᪵᪵᪵᪵᪵᪵᪵ࣧࣧ,gifPlayback: true }, { quoted: m });
 }
break;
case 'apk': {
...
case "movie": 
 ...
 break;
      ...
      case "Ami": case "owner": case "Hammy": 
 client.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/6b0e00c0fbd44e475b5a0.mp4' }, caption: `𝐇𝐞𝐫𝐞 𝐢𝐬 𝐦𝐲 𝐇𝐚𝐧𝐝𝐬𝐨𝐦𝐞 𝐎𝐰𝐧𝐞𝐫, +254799384249 (>ᴗ•)🤭` }, {quoted: m}); 
 ...
 break;
        ...
        case "gpt": case "g": 
            ...
            if (!text) return reply("Hello am 𝘼𝙈𝙄 an Ai developed by 〄༒𝐇𝐀𝐌𝐌𝐘➳ᴹᴿ᭄, how can I help you today?");
