...
let botname = process.env.BOTNAME || '𝘼𝙈𝙄_𝐀𝐈';
...
function _0x2f66() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      let reason = new Boom(lastDisconnect?.mosr)?.output.statusCode;
...
(function (_0x12ec2d, _0x25bf65) {
    ...
    while (!![]) {
      ...
      console.log(color("Follow me on Instagram as ", "red"));
      console.log(color("Text the bot number with !menu to check my command list"));
      client.sendMessage(owner + "@s.whatsapp.net", { text: `[𝘼𝙈𝙄 𝐁𝐎𝐓] 𝐡𝐚𝐬 𝐬𝐭𝐚𝐫𝐭𝐞𝐝. . .\n\n𝐁𝐎𝐓 𝐑𝐔𝐍𝐍𝐈𝐍𝐆\n\nHave fun with the bot😁\n\ncontact +254799384249 incase of any issues` });
    }
